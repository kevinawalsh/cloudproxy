...
echo
date
echo "plain tls, kvm server, base client"
echo $0
...
cp /home/$USER/src/go/bin/{standalone_ca_server,tao_launch} ${LHTEMP}
chmod a+rx ${LHTEMP}/{standalone_ca_server,tao_launch}
...
echo "starting kvm server"
$KVM_RUN /media/tao/standalone_ca_server -host 0.0.0.0 -n 1001 -sappcahost 172.27.35.103 &

echo "running base client"
tao run offline_ca_client -host 172.27.35.103 -port 18123 -n 1001 -sappcahost 172.27.35.103
sleep 2
