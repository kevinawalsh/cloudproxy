...
cp /home/$USER/src/go/bin/{hosted_psk_client,tao_launch} ${LHTEMP}
chmod a+rx ${LHTEMP}/{hosted_psk_client,tao_launch}
...
$KVM_RUN /media/tao/hosted_psk_client -save_name /tmp/prin-client
$KVM_RUN sudo cp /tmp/prin-client /media/tao/
...
$KVM_RUN /media/tao/hosted_psk_client -level 1 -host 172.27.35.103 -n 1001 -peer_prins "`cat ${LHTEMP}/prin-*`"
